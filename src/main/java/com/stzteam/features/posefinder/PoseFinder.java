...
public class PoseFinder{
    ...
    private final ICommandSwerveDrivetrain drivetrain;
    ...
    public PoseFinder(ICommandSwerveDrivetrain drivetrain, PathConstraints defaultConstraints) {
    ...
    public Command toPath(String pathName) {
        return Commands.defer(() -> {
            try {
                ...
                DriverStation.reportError("PoseFinder: Path not found " + pathName, true);
